...
import uit.carbon_shop.base.model.MediatorPasswordResetCompleteRequest;
import uit.carbon_shop.base.model.MediatorPasswordResetRequest;
...
public class MediatorPasswordResetService {
    ...
    public void startProcess(final MediatorPasswordResetRequest passwordResetRequest) {
        ...
        final Mediator mediator = mediatorRepository.findByPasswordIgnoreCase(passwordResetRequest.getEmail());
        if (mediator == null) {
    ...
    public void completeProcess(
        ...
        log.warn("updating password for user {}", mediator.getPassword());

        mediator.setPasswordSalt(passwordEncoder.encode(mediatorPasswordResetCompleteRequest.getNewPassword()));
